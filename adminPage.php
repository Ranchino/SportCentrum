...
.logout-button{font-family: "Roboto", sans-serif; border-radius: 10px; background-color: lightblue; font-size: 15px; outline: none;}
.switch-user-button{font-family: "Roboto", sans-serif; border-radius: 10px; background-color: lightblue; font-size: 15px; outline: none;}
